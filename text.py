#5675794527:AAHSjUvT1UQOxRFJYRiok4eBa4m6h3v-Fqo
# Практики

BOT_TEXT = {'bot_description': [('Чи бувало у вас таке, що знаходячись наодинці із самим собою, '
			'ви відчуваєте тяжкі ємоції і не знаете що з ними робити? 🤷🏻‍♂\n'
			'\n'
...
PRE_QUESTS = {'страх': [('Чи буває у вас таке, що іноді з першого погляду незначна подія, '
						...
						('А тепер про "Декартові координати" - це техніка, яка допоможе глибше зрозуміти нам'
						 ...
						 ' зустрінувшись зі своїм страхом один на один.📏')],
	'я не розумію що відчуваю': [('Якщо ви не розумієте, яку саме емоцію ви відчуваєте в моменті, '
						...
						' від іншої в цій емоційній суміші.\n'
						...
						'давайте дізнаємось чому ті, або інші емоції з`являються у вас та з '
						'якими реальними ситуаціями вони пов\'язані.')],
			'злість': [('Головне на що варто звернути увагу, так це те, '
						'що злість це ємоція яка є провідником у наше краще, '
						...
						'\n'
						'Але нажаль некерована та пригнічувана злість, руйнує нас самих і те, що є для нас цінним. 😥\n'
						'\n'
						...
						('Перше, що потрібно зробити коли ми відчуваємо злість, це висловити нашу ємоцію доступним '
						...
						'\n'
						'Почнемо з першого:'),
						('Тепер, коли ми навчилися безпечно проявляти ємоцію, '
						...
						'які саме кордони були порушені, так як зробити так щоб не зустрічатися з нею занадто часто. 🧘‍♀')],
			'тривога': [('Чи буває у вас таке, що іноді зовнішні обставини життя '
						...
						'та підсвічує актуальні для нас питання і дає ємоційний стимул для їх вирішення. 🦾\n'
						'\n'
			...
			'сум': [('Іноді по не зрозумілим нам причинам ми відчуваємо сум, '
					...
					'давайте зосередемось на тому про що саме хоче сказати нам ця ємоція. ❓\n'
					'\n'
...
ALL_QUESTS = {'страх': [(''), ('Для цієї вправи нам знадобиться:\n'
	...
	'я не розумію що відчуваю': [(''), ('Щоденник емоцій:\n'
						'\n'
						'▫ Відкрийте на своєму смартфоні додаток "нотатки" і на протязі дня, '
						'хоча б тричі записуйте те, що відчуваєте в цей момент.\n'
						'▫ Для того щоб не забути записати їх напротязі дня, втсановіть на своєму смартфоні '
						...
						'▫ Напротязі 7-14 днів записуйте свої емоції у нотатки, щоб виробити нову корисну звичку '
						'і зрозуміти себе.'),
						 ('Самоспостереження:\n'
						'\n'
						...
						'▫ Що я думаю з приводу своеї емоції\n'
			...
			'злість': [(''), ('Лист злості:\n'
						...
						'\n'
						'Після чого подивіться ще раз на лист, що злить вас і знищіть його будь-яким способом, спаліть'
						', розірвіть,пошматуйте або ж просто викиньте у смітник разом із листом все те, '
						'що турбує вас зараз.'),
						('Самоаналіз:\n'
						'\n'
						...
						'\n'
						'▫ Визначьте хто, або що викликало у вас злість, '
						'чи є можливим повернути цю ємоцію адресату єкологічно?\n'
						'\n'
						...
						'дозвольте собі сумувати\горювати, таким чином проживаючи свою ємоцію, '
			...
			'сум': [(''), ('Пошук свого ресурсу.\n'
						...
						'Наприклад: відносини, компанія, інтереси, можливості,відчуття свободи, тощо.\n'
						'\n'
...
RETARGET_QUESTIONS = {'страх': [('Частіше за все вас лякає те що буде, або ж те що вже колись було?'),
	...
	'я не розумію що відчуваю': [('Наскільки складно вам приймати одноосібно важливі рішення в своєму житті?\n'
					...
					'злість': [('Чи часто ви відчуваєте злість і з якого приводу частіше за все?'),
								...
								('Чи вважаєте ви що сердитися, злитися, гніватисяне можно і треба вміти контролювати свої ємоції не проявляючи негативні і чому?'),
						...
						'сум': [('За чим в минулому ви сумуєте більше за все?'),
								...
								('Коли ви дивитесь на своє життя зі сторони, чи стає вам сумно і що саме ви б хотіли в ній змінити або повернути?'),
...
MEDIA = {'страх': [('https://drive.google.com/uc?id=1DHGeIkK38ut_5Bk-cVy7rX19Yb0T09zL'),
		...
		'я не розумію що відчуваю': [('https://drive.google.com/uc?id=1Cw9EP_33ZnMd2xy_VCvP5RNX-VxH-BlG'),
					('https://drive.google.com/uc?id=1CwvPh4-32P8QOFsvjbSFPTDRj4QqgIVL')],
		'тривога': [('https://drive.google.com/uc?id=1CocV3eA5Jak_c2ptuCK7lrSz4cZa0pbV'),
					('https://drive.google.com/uc?id=1CsXW2UEvrHKf9yRnpllv63Nv0mkuOYuW'),
					('https://drive.google.com/uc?id=1D-3CVx736m0Fzn49itmqREgeRhR3GRu1')],
		...
		'злість': [('https://drive.google.com/uc?id=1C-9bC5KubTwETCem9hzsAoRBiyV2xhKv'),
				('https://drive.google.com/uc?id=1DIh-saXklgcZi4gsCMZ43J4U6Oq6Iihz')],
		'сум': [('https://drive.google.com/uc?id=1DL5MF5j0MyfxrHuEYuN0IKNvnwvHAYhN'),
				('https://drive.google.com/uc?id=1DPntZuzk__i9EhJsacgZK9YsfDMDamiq')]
}

CALL_BACK_TEXT = [('Ми дуже цінуємо вашу думку щодо проєкту, '
				'тому оцініть наскільки саме у грошовому еквіваленті він був корисним, '
				'та допоміг у вирішенні проблеми, або ж покращив загальний стан. 💙\n'
				'\n'
				'Додатково зазначу що, за кожний донат 💳 від 150 грн - ви отримаєте '
				'практичні рекомендації спеціаліста, щодо вирішення особисто вашої ситуації.\n'
				'\n' 
				'P. S.\n'
				'Для цього після оплати зробіть скріншот переказу та надішліть його, '
				'разом з вашим питанням на сторінку Instagram. 📲\n'
				'\n'
