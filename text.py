...
ALL_QUESTS = {'страх': [(''), ('Для цієї вправи нам знадобиться:\n'
	...
	'я не розумію що відчуваю': [(''), ('Щоденник емоцій:\n'
						...
						'▫ Для того щоб не забути записати їх напротязі дня, встановіть на своєму смартфоні '
...
MEDIA = {'страх': [('https://drive.google.com/uc?id=1DHGeIkK38ut_5Bk-cVy7rX19Yb0T09zL'),
		...
		'я не розумію що відчуваю': [('https://drive.google.com/uc?id=1ETDzEcCAau4mFXIZ52-MYaCcFWB6kEeJ'),
					('https://drive.google.com/uc?id=1EMwAoF298wSY7eqwYRaISrsJziGCjcjj'),
					('https://drive.google.com/uc?id=1F5AnaddTpME-MGaj1Z82KCkkax829XNE')],  # єдине фото в передописі
		'тривога': [('https://drive.google.com/uc?id=1Ebp64Qql96cZOWkNoZG-xkGxnVETiHLL'),
		...
		'сум': [('https://drive.google.com/uc?id=1EwpYPOWpLAMawsbxZF1D3dDqxQYzSWa-'),
				('https://drive.google.com/uc?id=1Ef1qL1LXRQTpeVjYemwa6zbevp_G6rAZ')]
}
...
CALL_BACK_TEXT = [('Ми дуже цінуємо вашу думку щодо проєкту, '
				...
				'\n'
				'<b>Номер карти для підтримки проекту</b>:\n\n'
